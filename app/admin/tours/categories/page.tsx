                ...
                filteredCategories.map((cat) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center ${isEditing === cat.id ? "bg-emerald-500 text-white" : "bg-emerald-100 text-emerald-600"} transition-colors`}
                      >
