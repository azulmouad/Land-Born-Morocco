...
export default function Footer() {
  return (
    <footer
      id="contact"
      className="bg-deep-blue text-white pt-16 md:pt-20 pb-10"
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12 md:mb-16">
        {/* Brand */}
        <div>
          ...
          <p className="text-gray-300 leading-relaxed max-w-xs">
            Authentic Moroccan experiences tailored just for you. Let us guide
            you through the magic of our homeland.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a
              href="#"
              className="bg-white/10 p-3 rounded-full hover:bg-sand transition-colors"
            >
              <Instagram size={20} />
            </a>
            <a
      ...
      <div className="border-t border-white/10 pt-8 text-center text-gray-400 text-sm">
        <p>
          &copy; {new Date().getFullYear()} Land Born Morocco. All rights
          reserved.
        </p>
      </div>
    </footer>
